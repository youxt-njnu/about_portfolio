...
export const chart_4_option = {
  backgroundColor: 'transparent',
  color: ['#000000', '#00e6f6', '#8ae66e', '#ff013c'], //全局调色盘;就近取色，第一个给了第一个series，第二个给了第二个series
  textStyle: {
    color: '#f9f002',
  },
  radiusAxis: {
  ...
  series: [
    {
      type: 'bar',
      data: [4, 3, 2, 1, 0], //这里和[2,2,2,1,0]效果是一样的，英文angleAxis的max是2
...
export const chart_5_option = {
  ...
  tooltip: {
    ...
    axisPointer: {
      type: 'cross',
      label: {
        backgroundColor: '#6a7985', // cross定位当前鼠标点，然后设置对应到xy轴的label的背景颜色
      },
    },
  },
  grid: {
